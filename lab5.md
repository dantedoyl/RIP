...
В этой лабораторной работе вы познакомитесь с популярной СУБД MySQL,
создадите свою базу данных. Также вам нужно будет дополнить свои классы
предметной области, связав их с созданной базой. После этого вы создадите свои
модели с помощью Django ORM, отобразите объекты из БД с помощью этих моделей.
Для сдачи вы должны иметь:
1. Скрипт с подключением к БД и несколькими запросами.
2. Модели вашей предметной области из предыдущей ЛР (минимум три модели, т.е. три таблицы)
3. View для отображения списка всех ваших сущностей
...
![Создание проекта](/assets_lab5/2.png)
...
Есди эта команда не срабатывает, то права доступа можно выдать через Workbench

![Создание проекта](/assets_lab5/1.png)

Теперь можно создавать таблицу в этой базе данных, но сначала нужно в
нее перейти:

![Создание проекта](/assets_lab5/3.png)
...
![Создание проекта](/assets_lab5/4.png)
...
![Создание проекта](/assets_lab5/5.png)
...
модели по предметной области из прощлой лабораторной работы.
...
здесь: https://docs.djangoproject.com/el/1.10/ref/models/querysets/
...
![Создание проекта](/assets_lab5/6.png)

![Создание проекта](/assets_lab5/7.png)